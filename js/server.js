...
(function () {
  ...
  var errorHandler = function (errorMess) {
    var elErrorTemplate = document.querySelector('#error').content.querySelector('div.error');
    elError = elErrorTemplate.cloneNode(true);
    var elErrorMess = elError.querySelector('.error__message');
  ...
  var successHandler = function (successMess) {
    var elSuccessTemplate = document.querySelector('#success').content.querySelector('div.success');
    elSuccess = elSuccessTemplate.cloneNode(true);
    var elSuccessMessage = elSuccess.querySelector('.success__message');
